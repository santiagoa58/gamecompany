...
class PaypalPro
{
    ...
    var $proxyPort = 808;
    var $paypalURL = (PAYPAL_SANDBOX == TRUE)?'https://www.sandbox.paypal.com/webscr&cmd=_express-checkout&token=':'https://www.paypal.com/webscr&cmd=_express-checkout&token=';
    var $version = '65.1';
